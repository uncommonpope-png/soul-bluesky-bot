...
function loadContentLibrary() {
  ...
  try {
    if (fs.existsSync(CONTENT_FILE)) {
      ...
      const all = [];
      for (const key of ['souls', 'plt_wisdom', 'soulverse', 'announcements', 'gsk_messages', 'mysteries', 'sacred_text', 'product_deep_links', 'curiosity_hooks', 'comparison', 'social_proof', 'problem_solution', 'behind_the_scenes', 'urgency', 'standalone']) {
