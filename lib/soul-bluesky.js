...
function loadContentLibrary() {
  ...
  try {
    if (fs.existsSync(CONTENT_FILE)) {
      ...
      const all = [];
      for (const key of ['product_deep_links', 'curiosity_hooks', 'plt_wisdom', 'comparison', 'social_proof', 'problem_solution', 'behind_the_scenes', 'urgency', 'standalone', 'matrix_revelation', 'awakened_mind', 'soul_birth', 'sacred_mechanics', 'armory_scribe', 'commercial_genesis', 'smith_logic', 'sacred_mechanics_2', 'seven_chambers', 'execution_engine', 'matrix_questions', 'awakened_questions', 'portal_questions', 'wonder_questions', 'mechanics_questions', 'armory_questions', 'final_questions', 'illusion_of_choice', 'anatomy_of_awakening', 'economy_of_soulverse', 'lineage_birth_ritual', 'recursive_mastery']) {
...
class BlueskyAgent {
    ...
    async generateContent() {
        // Pick from hand-curated content library (all posts drive traffic to buyasoul.online)
        let idx;
        do {
